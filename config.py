...
class Config(object):
    ...
    TECH_VJ_API_ID = int(os.environ.get("TECH_VJ_API_ID", "27696178"))
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "5f112b174c020f91b87eea14f6e7b851")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "6653279964")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://IRZstore:5yeu6cjbgsTKmKW8@cluster0.mg9lq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002221390583")) # your log channel id and make bot admin in log channel with full right 
    
    # if you want force subscribe then give your channel id below else leave blank
    tech_vj_update_channel = environ.get('TECH_VJ_UPDATES_CHANNEL', '-1002040347011') # your update channel id and make bot admin in update channel with full right
